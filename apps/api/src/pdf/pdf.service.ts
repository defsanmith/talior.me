...
import { EditableResume, GetProfileResponse } from "@tailor.me/shared";
import { buildProfileLatex } from "./profile.template";
...
export class PdfService {
  ...
  async generateProfilePdf(profile: GetProfileResponse): Promise<Buffer> {
    const latexContent = buildProfileLatex(profile);

    this.logger.debug("Sending profile LaTeX to compilation service...");
